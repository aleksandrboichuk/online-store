    ...
    <div class="filters-all">
        ...
        <div class="col-sm-6 col-xs-6 col-md-4 col-lg-1 filters"> @if(isset($brands) && !empty($brands))
                <div class="filter-item">
                    ...
                    <div class="fil-params">
                        <ul>
                            <li class="filter-check brand" data-filter="none-brand"><input class="filter-input" autocomplete="off" id="none-brand" type="checkbox" name="Brand" checked><label for="none">Всі</label></li>
                        @foreach($brands as $b)
        ...
        <div class="col-sm-6 col-xs-6 col-md-4 col-lg-1 filters ">@if(isset($colors) && !empty($colors))
                <div class="filter-item">
                    ...
                    <div class="fil-params">
                        <ul>
                            <li class="filter-check color" data-filter="none-color"><input class="filter-input" autocomplete="off" id="none-color" type="checkbox" name="Color" checked><label for="none">Всі</label></li>
                        @foreach($colors as $c)
        ...
        <div class="col-sm-6 col-xs-6 col-md-4 col-lg-1 filters "> @if(isset($materials) && !empty($materials))
                <div class="filter-item">
                    ...
                    <div class="fil-params">
                        <ul>
                            <li class="filter-check material" data-filter="none-material"><input class="filter-input" autocomplete="off" id="none-material" type="checkbox" name="Material" checked><label for="none">Всі</label></li>
        ...
        <div class="col-sm-6 col-xs-6 col-md-4 col-lg-1 filters"> @if(isset($seasons) && !empty($seasons))
                <div class="filter-item">
                    ...
                    <div class="fil-params">
                        <ul>
                            <li class="filter-check season" data-filter="none-season"><input class="filter-input" autocomplete="off" id="none-season" type="checkbox" name="Season" checked><label for="none">Всі</label></li>
        ...
        <div class="col-sm-6 col-xs-6 col-md-4 col-lg-1 filters ">@if(isset($sizes) && !empty($sizes))
                <div class="filter-item">
                    ...
                    <div class="fil-params">
                        <ul>
                            <li class="filter-check size" data-filter="none-size"><input class="filter-input" autocomplete="off" id="none-size" type="checkbox" name="Size" checked><label for="none">Всі</label></li>
                        @foreach($sizes as $si)
