                    ...
                    <div class="contact-form">
                        ...
                        <form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="{{route('send.message')}}" >
                            ...
                            <div class="form-group col-md-6">
                                <input type="text" name="name" value="{{$user->first_name}}" class="form-control" required="required" placeholder="Ім'я" />
                            </div>
                            <div class="form-group col-md-6">
                                <input type="email" name="email" value="{{$user->email}}" class="form-control" required="required" placeholder="Ел. пошта" />
                            </div>
