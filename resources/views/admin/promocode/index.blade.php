...
@section('content')
    ...
    <section id="table_items">
        ...
        <div class="container">
            <div class="row">
                <div class="btn-admin">
                    <a href="/admin/promocode/add"><button type="button" class="btn btn-default todo-btn">Додати</button></a>
                </div>
                {{--<div class="btn-admin">--}}
            ...
            <div class="table-responsive general-table-index general-table-index-with-pagination">
                <table class="table table-condensed table-admin-with-pagination">
                    ...
                    @foreach($promocodes as $promocode)
                        <tr>
                            ...
                            <td>
                                <form action="{{route('delete.promocode',$promocode->id)}}" method="post">
                            ...
                            <td>
                                <a href="{{route('edit.promocode', $promocode->id)}}" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                ...
                {{$promocodes->appends(request()->query())->links('parts.pagination')}}
            </div>
        </div>
    </section>
