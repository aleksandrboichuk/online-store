...
@section('content')
    ...
    <section id="table_items">
        ...
        <div class="container">
            <div class="row">
                <div class="btn-admin">
                    <a href="/admin/materials/create"><button type="button" class="btn btn-default todo-btn">Додати</button></a>
                </div>
            </div>
                ...
                <table class="table table-condensed">
                    ...
                    @foreach($materials as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('materials.edit', $item->id)}}" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
