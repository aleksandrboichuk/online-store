...
@section('content')
    ...
    <section id="cart_items">
        <div class="container">
            ...
            <div class="row">
                <div class="add-admin">
                    <a href="/admin/sizes/add"><button type="button" class="btn btn-warning">Додати</button></a>
                </div>
            </div>
                ...
                <table class="table table-condensed">
                    ...
                    @foreach($sizes as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('edit.size', $item->id)}}" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
