...
@section('content')
    ...
    <section id="table_items">
        ...
        <div class="container">
            <div class="row">
                <div class="btn-admin">
                    <a href="{{route('products.create')}}"><button type="button" class="btn btn-default todo-btn">Додати</button></a>
                </div>
            </div>
            <div class="table-responsive general-table-index general-table-index-with-pagination">
                <table class="table table-condensed table-admin-with-pagination">
                    ...
                    <tr class="general_menu">
                        ...
                        <td><b>Назва</b></td>
                        <td><b>SEO</b></td>
                        <td class="image"><b>Зображення</b></td>
                        <td><b>Ціна</b></td>
                        <td><b>Залишок (шт.)</b></td>
                        <td><b>Група категорій</b></td>
                        <td><b>Категорія</b></td>
                    ...
                    @foreach($products as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('products.edit', $item->id)}}" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
