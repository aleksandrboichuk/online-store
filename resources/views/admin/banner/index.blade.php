...
@section('content')
    ...
    <section id="table_items">
        ...
        <div class="container">
            <div class="row">
                <div class="btn-admin">
                    <a href="{{route('banners.create')}}"><button type="button" class="btn btn-default todo-btn">Додати</button></a>
                </div>
            </div>
                    ...
                    @foreach($banners as $item)
                        <tr>
                            ...
                            <td class="cart_product">
                                <img src="/images/banners/{{$item->id}}/{{$item->image_url}}" alt="" />
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{route('banners.edit', $item->id)}}" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
