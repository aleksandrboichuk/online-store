                            ...
                            @if($key == 0)
                                <div class="item active">
                                    <div class="col-sm-12 banner-column-block">
                                        <img src="/images/banners/{{$value->id}}/{{$value->image_url}}" class="banner-img img-responsive" alt="" />
                                        {{--@if(isset($value->mini_img_url) && !empty($value->mini_img_url))--}}
                                            {{--<img src="/images/banners/{{$value->id}}/{{$value->mini_img_url}}" class="mini-banner-img" alt="" />--}}
                                        {{--@endif--}}
