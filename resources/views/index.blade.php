                ...
                if (div.find('.fil-params').hasClass('fil-active')) {
                    ...
                    for (let i = 0; i < color.length; i++) {
                        if (color[i].firstChild.checked) {
                            colors.push(color[i].textContent);
                        }
                    }
                    /* brands array */
                    ...
                    for (let i = 0; i < brand.length; i++) {
                        if (brand[i].firstChild.checked) {
                            brands.push(brand[i].textContent);
                        }
                    }
                    ...
                    for (let i = 0; i < material.length; i++) {
                        if (material[i].firstChild.checked) {
                             materials.push(material[i].textContent);
                    ...
                    for (let i = 0; i < season.length; i++) {
                        if (season[i].firstChild.checked) {
                            seasons.push(season[i].textContent);
                        }
                    }

                    console.log(colors,seasons,sizes,materials);
