...
## Розгортання проєкту 
**_[У найближчий час буде інтегровано Docker + NGINX + php-fpm + mysql + elasticsearch. 
Поки що для роботи пошуку потрібно завантажити Elasticsearch безпосередньо на ПК]_**
