$(document).ready(function() {
     ...
     * ----------------------------
     *
     * Pagination with button load more
     *
     * ----------------------------
     */
     ...
     * ----------------------------
     *
     * Formation query string for filtration
     *
    ...
    let brands = [], colors = [], materials = [], seasons = [], sizes = [];
    let priceFrom;
    let priceTo;
    ...
    /**
     * Defines arrays of properties from query string
     */
    function defineArrayProperties(){
        priceFrom = parseInt($('input[name="from-price"]').val());
        priceTo = parseInt($('input[name="to-price"]').val());
